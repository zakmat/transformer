 ...
 */
enum XMLSymbol {
	OPENTAG, OPENENDTAG, OPENPI, OPENCDATA, OPENCOMMENT, CDSECTION, COMMENT, CLOSETAG, ENDEMPTYELEM, ENDPI,
	ENDCDATA, ENDCOMMENT, EQUALOP, MINUS, COLON, NAME, LITERAL, ID, WS, OTHER, MAXSYM
};
